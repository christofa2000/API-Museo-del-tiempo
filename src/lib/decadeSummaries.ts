...
export const decadeSummaries: Record<number, string> = {
  ...
  1990: "Fin de la Guerra Fría y expansión del internet. La cultura se volvió digital y multicultural. Surgieron nuevas democracias y una economía más globalizada.",
  2000: "Comienzo del siglo XXI marcado por los atentados del 11-S. Auge de la tecnología móvil y las redes sociales. Se aceleró la conexión digital y la cultura global.",
  2010: "Década de innovación tecnológica y conciencia social. Expansión del streaming, el smartphone y los movimientos globales. El mundo vivió cambios políticos, climáticos y digitales profundos.",
};
